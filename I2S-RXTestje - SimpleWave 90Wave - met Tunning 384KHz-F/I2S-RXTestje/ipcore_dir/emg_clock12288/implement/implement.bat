...
xst -ifn xst.scr
move emg_clock12288_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\emg_clock12288_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc emg_clock12288_exdes.ucf emg_clock12288_exdes

echo 'Running map'
map -timing -pr b emg_clock12288_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm emg_clock12288_exdes -w routed.ncd routed.v
cd ..
